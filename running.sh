...
# Author  : lerryvpn
# (C) Copyright 2000-2080 By TIKTOK
# =========================================
...
echo -e "         OWNER : ${GREEN}TIKTOK ${NC}${YELLOW}(${NC} ${GREEN}TIKTOK ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By TIKTOK ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
...
echo ""
read -n 1 -s -r -p "Press any key to back on menu BY : TIKTOK"
menu
