...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/lerryvpn/izin/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/lerryvpn/izin/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/lerryvpn/izin/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/lerryvpn/izin/main/ip | grep $MYIP | awk '{print $3}')
fi
...
a=" ${CYAN}TERIMAKASIH SUDAH MENGGUNAKAN SCRIPT BY TIKTOK"
################
# // Clear
clear
clear && clear && clear
...
echo -e "  ${z}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m${NC}"
echo -e "  ${z}|\033[41m   ⇱ INFORMATIONS VPS By : TIKTOK⇲            ${NC}${z}|${NC}"
echo -e "  ${z}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"
